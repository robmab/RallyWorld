 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Fitness_Hub_Team' ) ) {

    class Fitness_Hub_Team extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                    ...
                    esc_html__('AT Team/Speakers Section', 'fitness-hub'),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show Team Section.', 'fitness-hub' )
                    )
            );
        }
	               ...
	               if ( ! empty( $title ) ) {
                    ...
                    <div <?php echo $div_attr;?>>
                        ...
                        if( !empty ( $post_in ) && is_array( $post_in ) ) :
                            ...
                            $team_query = new WP_Query( $fitness_hub_post_in_page_args );
                            /*The Loop*/
    ...
    } // Class Fitness_Hub_Team ends here
}