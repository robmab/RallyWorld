 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Fitness_Hub_Contact' ) ) {

    class Fitness_Hub_Contact extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                    ...
                    esc_html__('AT Contact Section', 'fitness-hub'),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show Contact Section.', 'fitness-hub' )
                    )
            );
        }
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'shortcode' ); ?>"><?php esc_html_e( 'Enter Shortcode', 'fitness-hub' ); ?>:</label>
                ...
                <small>
                    <?php
                    printf( esc_html__( 'Download contact form 7 from %1$shere%2$s', 'fitness-hub' ), "<a target='_blank' href='".esc_url( 'https://wordpress.org/plugins/contact-form-7/' )."''>","</a>" );
                    ?>
                </small>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'page_id' ); ?>"><?php esc_html_e( 'Select Page For Contact', 'fitness-hub' ); ?>:</label>
                <br />
                <small><?php esc_html_e( 'Select page and its title and excerpt will display in the frontend. No need of subpages.', 'fitness-hub' ); ?></small>
                <?php
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'single_page_content_from' ); ?>"><?php _e( 'Page Content From', 'fitness-hub' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'single_page_content_number' ); ?>"><?php _e( 'Number of page words in content', 'fitness-hub' ); ?>:</label>
                <br/>
                <small>
        ...
        public function update( $new_instance, $old_instance ) {
            ...
            $instance[ 'page_id' ]              = fitness_hub_sanitize_page( $new_instance[ 'page_id' ] );

	        $fitness_hub_about_content_from           = fitness_hub_content_from();
	        $instance['single_page_content_from']       = fitness_hub_sanitize_choice_options( $new_instance['single_page_content_from'], $fitness_hub_about_content_from, 'content' );
                    ...
                    <div class="container">
                        <div class="row">
	                        ...
	                        if( !empty ( $page_id ) ) :
		                        ...
		                        $contact_page_query = new WP_Query( $fitness_hub_post_in_page_args );
		                        /*The Loop*/
                                        ...
                                        <div class="col-md-6  <?php echo $animation; ?>">
                                            <div class="contact-page-content">
                                                ...
                                                if( 0 != $single_page_content_number ){
                                                    fitness_hub_advanced_content( $single_page_content_number, $single_page_content_from );
                                                }
                                                ?>
                                            </div>
                                        </div>
    ...
    } // Class Fitness_Hub_Contact ends here
}